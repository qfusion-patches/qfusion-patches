...
const field_t fields[] = {
	...
	{ "helpmessage", FOFS( helpmessage ), F_LSTRING, 0 },
	...
	{ "health", FOFS( health ), F_FLOAT, 0 },
	{ "sounds", FOFS( sounds ), F_LSTRING, 0 },
	{ "light", FOFS( light ), F_FLOAT, 0 },
	{ "color", FOFS( color ), F_VECTOR, 0 },
	{ "dmg", FOFS( dmg ), F_INT, 0 },
	{ "angles", FOFS( s.angles ), F_VECTOR, 0 },
	{ "mangle", FOFS( s.angles ), F_VECTOR, 0 },
