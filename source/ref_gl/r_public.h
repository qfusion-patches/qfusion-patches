...
typedef struct
{
	...
	rserr_t		( *Init )( const char *applicationName, const char *screenshotsPrefix, int startupColor, int iconResource, const int *iconXPM, void *hinstance, void *wndproc, bool verbose );
